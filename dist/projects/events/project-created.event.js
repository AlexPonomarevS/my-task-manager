...
let ProjectCreatedEvent = class ProjectCreatedEvent {
    constructor(name, members, initialStatus) {
        this.name = name;
...
exports.ProjectCreatedEvent = ProjectCreatedEvent = __decorate([
    (0, core_1.DomainEvent)('project-created-event'),
